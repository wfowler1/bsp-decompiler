...
namespace Decompiler
{
    ...
    public class BSPDecompiler
    {
        ...
        public BSPDecompiler(BSP bsp, Job master)
        {
            ...
            { _itemsToProcess += bsp.Entities.Count; }
            if (bsp.Brushes != null)
            { _itemsToProcess += bsp.Brushes.Count; }
            if (bsp.StaticProps != null)
            { _itemsToProcess += bsp.StaticProps.Count; }
            if (bsp.StaticModels != null)
            { _itemsToProcess += bsp.StaticModels.Count; }
            if (bsp.Cubemaps != null)
            { _itemsToProcess += bsp.Cubemaps.Count; }
            if (bsp.Overlays != null)
            { _itemsToProcess += bsp.Overlays.Count; }
        }
