...
public class v42TexMatrix {
	...
	public v42TexMatrix(float inUX, float inUY, float inUZ, float inUS,
	...
	public v42TexMatrix(float[] inUAxis, float inUS, float[] inVAxis, float inVS) {
		uAxis=inUAxis;
		uShift=inUS;
		vAxis=inVAxis;
		vShift=inVS;
